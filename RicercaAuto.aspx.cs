...
public partial class _Default : System.Web.UI.Page
{
    ...
    // mette i dati nella griglia con il modello
    ...
    //        gridAuto.DataSource = a.AutoGrid();
    //        gridAuto.DataBind();
    //    }
    ...
    {
        AUTOMOBILI a = new AUTOMOBILI();
        gridAuto.DataSource = a.GridAllAuto();
    ...
    // porta alla pagina aggiungiauto.aspx
    protected void btnAggiungi_Click(object sender, EventArgs e)
    {
        Response.Redirect("AggiungiAuto.aspx");
    }
    ...
    protected void gridAuto_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Response.Redirect("ModificaAuto.aspx?m=" + ModificaTarga);
    }
}